...
* Fork the repository and clone your fork
  * open the following URL in your browser: <https://github.com/RedHatInsights/parquet-factory>
  * click on the 'Fork' button (near the top right corner)
  * select the account for fork
  * open your forked repository in browser
...
* Make use of the merge request template. Select `Default` from the Description dropdown.
